...
from ledger.models import BaseEvent, StoredEvent, StreamMetadata
        ...
        async with self.db.transaction() as conn:
            ...
            for base_event in events:
                ...
                await conn.execute(
                    ...
                    base_event.event_version, base_event.payload, metadata
                )
        ...
        while True:
            ...
            async with self.db.get_connection() as conn:
                ...
                for row in rows:
                    ...
                    next_global_position = event.global_position + 1
